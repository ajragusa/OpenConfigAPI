...
class CountersSchema(Model):
    ...
    def __init__(self, out_error_pkts: str=None, in_pkts: str=None, out_forwarded_pkts: str=None, in_forwarded_octets: str=None, in_forwarded_pkts: str=None, in_octets: str=None, out_octets: str=None, in_discarded_pkts: str=None, out_pkts: str=None, in_error_pkts: str=None, out_discarded_pkts: str=None, out_forwarded_octets: str=None):  # noqa: E501
        """CountersSchema - a model defined in Swagger

        :param out_error_pkts: The out_error_pkts of this CountersSchema.  # noqa: E501
        :type out_error_pkts: str
        :param in_pkts: The in_pkts of this CountersSchema.  # noqa: E501
        :type in_pkts: str
        :param out_forwarded_pkts: The out_forwarded_pkts of this CountersSchema.  # noqa: E501
        :type out_forwarded_pkts: str
        :param in_forwarded_octets: The in_forwarded_octets of this CountersSchema.  # noqa: E501
        :type in_forwarded_octets: str
        :param in_forwarded_pkts: The in_forwarded_pkts of this CountersSchema.  # noqa: E501
        :type in_forwarded_pkts: str
        :param in_octets: The in_octets of this CountersSchema.  # noqa: E501
        :type in_octets: str
        :param out_octets: The out_octets of this CountersSchema.  # noqa: E501
        :type out_octets: str
        :param in_discarded_pkts: The in_discarded_pkts of this CountersSchema.  # noqa: E501
        :type in_discarded_pkts: str
        :param out_pkts: The out_pkts of this CountersSchema.  # noqa: E501
        :type out_pkts: str
        :param in_error_pkts: The in_error_pkts of this CountersSchema.  # noqa: E501
        :type in_error_pkts: str
        :param out_discarded_pkts: The out_discarded_pkts of this CountersSchema.  # noqa: E501
        :type out_discarded_pkts: str
        :param out_forwarded_octets: The out_forwarded_octets of this CountersSchema.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CountersSchema':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CountersSchema of this CountersSchema.  # noqa: E501
    ...
    def out_error_pkts(self) -> str:
        """Gets the out_error_pkts of this CountersSchema.
        ...
        :return: The out_error_pkts of this CountersSchema.
        :rtype: str
        """
    ...
    def out_error_pkts(self, out_error_pkts: str):
        """Sets the out_error_pkts of this CountersSchema.

        Number of IP packets for the specified address family locally generated and discarded due to errors, including no route found to the IP destination.  # noqa: E501

        :param out_error_pkts: The out_error_pkts of this CountersSchema.
        :type out_error_pkts: str
        """
    ...
    def in_pkts(self, in_pkts: str):
        """Sets the in_pkts of this CountersSchema.

        The total number of IP packets received for the specified address family, including those received in error  # noqa: E501

        :param in_pkts: The in_pkts of this CountersSchema.
        :type in_pkts: str
        """
    ...
    def out_forwarded_pkts(self) -> str:
        """Gets the out_forwarded_pkts of this CountersSchema.
        ...
        :return: The out_forwarded_pkts of this CountersSchema.
        :rtype: str
        """
    ...
    def out_forwarded_pkts(self, out_forwarded_pkts: str):
        """Sets the out_forwarded_pkts of this CountersSchema.

        The number of packets for which this entity was not their final IP destination and for which it was successful in finding a path to their final destination.  # noqa: E501

        :param out_forwarded_pkts: The out_forwarded_pkts of this CountersSchema.
        :type out_forwarded_pkts: str
        """
    ...
    def in_forwarded_octets(self) -> str:
        """Gets the in_forwarded_octets of this CountersSchema.
        ...
        :return: The in_forwarded_octets of this CountersSchema.
        :rtype: str
        """
    ...
    def in_forwarded_octets(self, in_forwarded_octets: str):
        """Sets the in_forwarded_octets of this CountersSchema.

        The number of octets received in input IP packets for the specified address family for which the device was not their final IP destination and for which the device attempted to find a route to forward them to that final destination.  # noqa: E501

        :param in_forwarded_octets: The in_forwarded_octets of this CountersSchema.
        :type in_forwarded_octets: str
        """
    ...
    def in_forwarded_pkts(self) -> str:
        """Gets the in_forwarded_pkts of this CountersSchema.
        ...
        :return: The in_forwarded_pkts of this CountersSchema.
        :rtype: str
        """
    ...
    def in_forwarded_pkts(self, in_forwarded_pkts: str):
        """Sets the in_forwarded_pkts of this CountersSchema.

        The number of input packets for which the device was not their final IP destination and for which the device attempted to find a route to forward them to that final destination.  # noqa: E501

        :param in_forwarded_pkts: The in_forwarded_pkts of this CountersSchema.
        :type in_forwarded_pkts: str
        """
    ...
    def in_octets(self) -> str:
        """Gets the in_octets of this CountersSchema.
        ...
        :return: The in_octets of this CountersSchema.
        :rtype: str
        """
    ...
    def in_octets(self, in_octets: str):
        """Sets the in_octets of this CountersSchema.

        The total number of octets received in input IP packets for the specified address family, including those received in error.  # noqa: E501

        :param in_octets: The in_octets of this CountersSchema.
        :type in_octets: str
        """
    ...
    def out_octets(self) -> str:
        """Gets the out_octets of this CountersSchema.
        ...
        :return: The out_octets of this CountersSchema.
        :rtype: str
        """
    ...
    def out_octets(self, out_octets: str):
        """Sets the out_octets of this CountersSchema.

        The total number of octets in IP packets for the specified address family that the device supplied to the lower layers for transmission.  This includes packets generated locally and those forwarded by the device.  # noqa: E501

        :param out_octets: The out_octets of this CountersSchema.
        :type out_octets: str
        """
    ...
    def in_discarded_pkts(self) -> str:
        """Gets the in_discarded_pkts of this CountersSchema.
        ...
        :return: The in_discarded_pkts of this CountersSchema.
        :rtype: str
        """
    ...
    def in_discarded_pkts(self, in_discarded_pkts: str):
        """Sets the in_discarded_pkts of this CountersSchema.

        The number of input IP packets for the specified address family, for which no problems were encountered to prevent their continued processing, but were discarded (e.g., for lack of buffer space).  # noqa: E501

        :param in_discarded_pkts: The in_discarded_pkts of this CountersSchema.
        :type in_discarded_pkts: str
        """
    ...
    def out_pkts(self) -> str:
        """Gets the out_pkts of this CountersSchema.
        ...
        :return: The out_pkts of this CountersSchema.
        :rtype: str
        """
    ...
    def out_pkts(self, out_pkts: str):
        """Sets the out_pkts of this CountersSchema.

        The total number of IP packets for the specified address family that the device supplied to the lower layers for transmission.  This includes packets generated locally and those forwarded by the device.  # noqa: E501

        :param out_pkts: The out_pkts of this CountersSchema.
        :type out_pkts: str
        """
    ...
    def in_error_pkts(self) -> str:
        """Gets the in_error_pkts of this CountersSchema.
        ...
        :return: The in_error_pkts of this CountersSchema.
        :rtype: str
        """
    ...
    def in_error_pkts(self, in_error_pkts: str):
        """Sets the in_error_pkts of this CountersSchema.

        Number of IP packets discarded due to errors for the specified address family, including errors in the IP header, no route found to the IP destination, invalid address, unknown protocol, etc.  # noqa: E501

        :param in_error_pkts: The in_error_pkts of this CountersSchema.
        :type in_error_pkts: str
        """
    ...
    def out_discarded_pkts(self) -> str:
        """Gets the out_discarded_pkts of this CountersSchema.
        ...
        :return: The out_discarded_pkts of this CountersSchema.
        :rtype: str
        """
    ...
    def out_discarded_pkts(self, out_discarded_pkts: str):
        """Sets the out_discarded_pkts of this CountersSchema.

        The number of output IP packets for the specified address family for which no problem was encountered to prevent their transmission to their destination, but were discarded (e.g., for lack of buffer space).  # noqa: E501

        :param out_discarded_pkts: The out_discarded_pkts of this CountersSchema.
        :type out_discarded_pkts: str
        """
    ...
    def out_forwarded_octets(self) -> str:
        """Gets the out_forwarded_octets of this CountersSchema.
        ...
        :return: The out_forwarded_octets of this CountersSchema.
        :rtype: str
        """
    ...
    def out_forwarded_octets(self, out_forwarded_octets: str):
        """Sets the out_forwarded_octets of this CountersSchema.

        The number of octets in packets for which this entity was not their final IP destination and for which it was successful in finding a path to their final destination.  # noqa: E501

        :param out_forwarded_octets: The out_forwarded_octets of this CountersSchema.
        :type out_forwarded_octets: str
        """
