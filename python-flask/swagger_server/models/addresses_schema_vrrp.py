...
class AddressesSchemaVrrp(Model):
    ...
    def __init__(self, vrrp_group: List[IpVrrpTrackingTop]=None):  # noqa: E501
        """AddressesSchemaVrrp - a model defined in Swagger

        :param vrrp_group: The vrrp_group of this AddressesSchemaVrrp.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'AddressesSchemaVrrp':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The AddressesSchema_vrrp of this AddressesSchemaVrrp.  # noqa: E501
    ...
    def vrrp_group(self) -> List[IpVrrpTrackingTop]:
        """Gets the vrrp_group of this AddressesSchemaVrrp.

        List of VRRP groups, keyed by virtual router id  # noqa: E501

        :return: The vrrp_group of this AddressesSchemaVrrp.
    ...
    def vrrp_group(self, vrrp_group: List[IpVrrpTrackingTop]):
        """Sets the vrrp_group of this AddressesSchemaVrrp.

        List of VRRP groups, keyed by virtual router id  # noqa: E501

        :param vrrp_group: The vrrp_group of this AddressesSchemaVrrp.
        :type vrrp_group: List[IpVrrpTrackingTop]
        """
